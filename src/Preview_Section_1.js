...
return(
    <div>
        ...
        <table style={{width:"100%",height:"120px",border:"1px solid black",marginTop:"10px",borderCollapse:"collapse"}}>
              ...
              <td style={{borderLeft:"1px solid black",margin:0,padding:0,textAlign:"center"}}>
                <img alt="Authorised Signature" src={signature} style={{border:"2px solid black",height:"75px",width:"150px",marginTop:"10%"}}/>
